...
basada en **Tauri 2** (backend en Rust + frontend web en **Preact (JSX, ~3 KB gz VDOM)**), que funcione en
...
- **Shell:** Tauri 2 (Rust).
- **Frontend:** Preact (JSX-compatible con React, runtime VDOM ~3 KB gz, bundles pequeños).
...
- **MVP:** app Tauri (Rust + Preact) arranca con los **4 proveedores desde el día 1** (OpenAI, Anthropic, Gemini, Ollama), chat con streaming, modos Plan/Build, edición con aprobación por acción.
...
- **En alcance:** la app de escritorio (core en Rust, adaptadores de proveedores, frontend en
  Preact, modos Plan/Build, detección de hardware, permisos de edición, terminal sandbox con
