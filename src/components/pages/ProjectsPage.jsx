      ...
      const defaults = [
        {
          id: "proj-1",
          name: "stark",
          path: "/home/bryan/Downloads/Repos/stark",
          branch: "main",
  ...
  const handleAddProject = async () => {
    ...
    if (!path) {
      ...
      try {
        ...
        alert(
          lang === "es"
            ? "Por favor escribe una ruta o ejecuta en Tauri"
            : "Please type a path or run in Tauri"
        );
        return;
      }
    }
    ...
    >
      ...
      >
        <div>
          ...
          >
            {isEs
              ? "Administra y cambia el foco entre repositorios de desarrollo locales"
              : "Manage and switch focus between local development repositories"}
          </p>
        </div>
      ...
      {isAdding && (
        ...
        >
          <h4 style={{ fontSize: "12px", margin: 0, fontWeight: "700" }}>
            {isEs
              ? "Registrar nuevo repositorio local"
            ...
            <div
              ...
              style={{
                background: isFocused
                  ? "var(--colors-surface-dark-elevated, #3a3a3a)"
                  : "var(--colors-surface-dark, #111111)",
                border: isFocused
