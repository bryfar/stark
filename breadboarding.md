...
> **Ubicación del repositorio:** [`/home/bryan/Downloads/Repos/crafter-repo/breadboarding.md`](file:///home/bryan/Downloads/Repos/crafter-repo/breadboarding.md)

Este documento transforma la **Forma A (Tauri 2 + Core Rust + Svelte 5)** de Crafter en un mapa completo de affordances (UI y Código) y sus relaciones de control (*Wires Out*) y datos (*Returns To*).
...
|---|-------|-------------|-------------|-----------------|
| **P1** | Main Window (Read/Chat Mode) | Frontend Svelte 5 | Interfaz principal de chat, configuración de LLM y visualización de respuestas. | No bloqueante |
| **P2** | Diff & Action Approval Modal | Frontend Svelte 5 | Modal de revisión de ediciones de código propuestas en Modo Build. | **Bloqueante** (Impide interactuar con P1 hasta aprobar/rechazar) |
